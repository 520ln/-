! function($) {
    ...
    function showlist(sid, num) { 
        ...
        $.ajax({
            ...
            $.each(data, function(index, value) {
                if (sid == value.sid) {
                    let $clonebox = $('.goods-item').clone(true, true); //克隆隐藏元素
    ...
    function calcsingleprice(obj) { //obj元素对象
       ...
       console.log(obj.parents('.goods-item').find('.b-price strong font font').html())
        let $dj = parseFloat(obj.parents('.goods-item').find('.b-price strong font font').html());
